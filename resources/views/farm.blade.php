                                ...
                                <td>{{ $farm->farmname }}
                                    @if ($farm->getlastreport() == 'CONDITIONAL')
                                        <div><br />
                                            <div><br />
                                                <span
                                                    class="position-absolute  translate-middle badge rounded-pill bg-warning ml-5">
                                                    Conditional
                                ...
                                <td>
                                    ...
                                    @if ($user->roles == 'ADMINISTRATOR' && $farm->inspectorid != null)
                                        <button type="button" class="btn btn-success" data-bs-toggle="modal"
                                            data-bs-target="#exampleModal" data-bs-whatever="{{ $farm->farmcode }}"
                                            data-toggle="tooltip" data-placement="right" title="Schedule Inspection"><i
                                                class="fa fa-calendar" aria-hidden="true"></i></button>
                                    @endif
                                    <a href="/farm/view?id={{ $farm->farmcode }}" type="button" class="btn btn-success"
                                        style="margin:3px" data-toggle="tooltip" data-placement="right"
                                        title="View Farm"><i class="fa fa-eye" aria-hidden="true"></i></a>
                                </td>
                            </tr>
                            ...
                            <form id="farmschedule" method="post" action='/farm/schedule'>
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" readonly class="form-control fcode" id="farmcode"
                                            name="farmcode">
                                    </div>
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" id="scheduletype" name="inspectiontype"
                                            ...
                                            @forelse ($reports as $report)
                                                <option value="{{ $report->id }}"> {{ $report->reportname }}
                                                </option>
                                            @empty
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="date" class="form-control" id="scheduledate"
                                            name="newinspectiondate" style="background-color:cornflowerblue">
                                    </div>
                                </div>
