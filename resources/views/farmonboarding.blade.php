        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
             ...
             <a href="{{route('feprofile')}}?fcode={{$farm->farmcode}}" type="button" class="btn btn-success" style="margin:3px" data-toggle="tooltip" data-placement="right" title="Begin Entrance exam"><i class="fa fa-print" aria-hidden="true"></i></a>
            </td>
          </tr>
