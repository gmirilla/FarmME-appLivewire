        ...
        <div>
            <div class="container-sm">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" readonly class="form-control"
                                    value="{{ number_format($farmdetails->getfarmareacurrent(), 2) }}">
                            </div>
                            <div class="mb-3">
                                ...
                                <form action="{{ route('generatecontract') }}" method="get">
                                    ...
                                    @if (!empty($season))
                                        <a href="{{ route('viewcontract', ['farmid' => $farm->id, 'cdseason' => $season]) }}"
                                            class="btn btn-success">View Contract Agreement</a>
                                        <button type="submit" class="btn btn-success">Download Contract
                                            Agreement</button>
                                    @else
                                        <a href="#" disabled class="btn btn-success">View Contract Agreement</a>
                                        <button type="submit" class="btn btn-success" disabled>Download Contract
                                            Agreement</button>
                                    @endif
                                </form>
                            </div>
                        ...
                        <div class="card-body mb-3">
                            <div class="row mb-3">
                                ...
                                <div class="d-flex">
                                    <div>
                                        <input type="text" readonly class="form-control"
                                            value="{{ $farm->farmstate }}" id=farmstate>
                                    </div>
                                    <div class="ml-2">
                                        @if ($authuser->roles == 'ADMINISTRATOR')
                                            <button type="button" class="btn btn-success py-2" data-bs-toggle="modal"
                                                data-bs-target="#farmModal" data-bs-whatever=""><i
                                                    class="fa fa-pencil-square-o"></i></button>
                                        @endif
                                    </div>
                                    <div class="ml-2"
                                        style="border: #5D4037 solid 1px; padding: 5px; border-radius: 5px;">
                                        ...
                                        @else
                                            <img id="uploadedImage"
                                                ...
                                                alt="No Photo Uploaded" style="width: 80px; height: 80px;">
                                        @endif
                                        ...
                                        @endif
                                        <button type="button" class="btn btn-success py-2" data-bs-toggle="modal"
                                            data-bs-target="#farmerPictureModal" data-bs-whatever=""><i
                                ...
                                <div>
                                    ...
                                    <table class="table table-bordered table-striped">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if (!empty($farmdetails->getfarmareacurrent()))
                                                    {{ number_format($farmdetails->getfarmareacurrent(), 2) }} Ha
                                                @endif
                                            </td>
                                            <td><b> No of Plots</b></td>
                                            <td>
                                                @if (!empty($farmdetails->getfarmcount()))
                                    ...
                                    <form action="/fu/edit" method="get">
                                        ...
                                        <button type="submit" class="btn btn-success" name="editfunits"> Edit Farm
                                            Details</button>
                                    </form>
                                        ...
                                        @if ($lastreport != null)
                                            ...
                                            <td>
                                                @php
                                                    ...
                                                    $farmscore = number_format(
                                                        ($lastreport->score / $maxscore) * 100,
                                                        2,
                                                    );
                                                @endphp
                                                @switch($farmscore)
                ...
                <div class="row table-responsive">
                    <h4 class="h4" style="text-align: center; background-color:#5D4037; color: white">INSPECTION
                        RECORDS</h4>
                        ...
                        <tbody>
                            @forelse ($farmreports as $farmreport)
                                <tr>
                                    ...
                                    <td>
                                        <textarea class="form-control" name="comments" id="" cols="20" rows="3">{{ $farmreport->comments }}</textarea>
                                    </td>
                                    <td>
                                        <form action="/iapprove" method="post">
                                            @csrf
                                            <input type="hidden" name="iid" value="{{ $farmreport->iid }}">
                                            <button name="viewsheet" type="submit" class="btn btn-success"><i
                                        ...
                                        <form action="{{ route('continue') }}" method="POST">
                                            ...
                                            <input type="text" value="{{ $farmreport->iid }}" name="inspectionid"
                                                hidden>
                                            <button class="btn btn-danger" name='printsheet' data-toggle="tooltip"
                                                data-placement="right" title="Download Inspection PDF"
                                                style="margin: 3px"><i class="fa fa-file-pdf-o"
                            ...
                            @empty
                                <tr>
                                    <td>NO INSPECTIONS CARRIED OUT</td>
                                    <td></td>
                                    <td></td>
                                    <td></td>
                                    <td></td>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="/farm/assignstaff" method="post">
                        ...
                        <div class="row">
                            <label>FARM NAME</label>
                            <input disabled type="text" readonly class="form-control"
                                value="{{ $farm->farmname }}">
