        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
             ...
             <a href="{{route('feprofile')}}?fcode={{$farm->farmcode}}" type="button" class="btn btn-success" style="margin:3px" data-toggle="tooltip" data-placement="right" title="Begin Farm Entrance"><i class="fa fa-pen" aria-hidden="true"></i></a>
            </td>
          </tr>
